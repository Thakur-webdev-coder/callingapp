...
(global => {
    ...
    if (typeof global.document === 'undefined') {
        ...
        if (elementPrototype) {
            if (typeof elementPrototype.querySelector === 'undefined') {
                elementPrototype.querySelector = function(selectors: any) {
    ...
    //     global.setTimeout = (fn: any, ms = 0) => BackgroundTimer.setTimeout(fn, ms);
    // }

    // localStorage
    if (typeof global.localStorage === 'undefined') {
        global.localStorage = new Storage('@nxatel/');
    }
